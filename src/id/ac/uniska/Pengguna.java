...
//        String loginSQL = "SELECT * FROM pengguna WHERE username = '"+this.username+"' AND password = MD5('"+this.password+"')";
    ...
    public boolean updatePassword(String passwordLama) {
        ...
        boolean hasil = false;
//        String cariSQL = "SELECT * FROM pengguna WHERE username = ? AND password = ?";
        ...
        if (passwordlamabenar) {
            ...
            try {
                ...
                System.out.println("Berhasil Memperbarui Password");
                hasil = true;
            } catch (SQLException e) {
                System.out.println("Password Yang diperbarui ERROR!");
            }
        }
        return hasil;
    }
